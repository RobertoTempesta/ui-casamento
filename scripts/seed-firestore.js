...
const PRESENTES_INICIAIS = [
  { nome: 'Forno Elétrico', descricao: 'Forno elétrico de embutir ou de mesa.', reservado: true, reservadoPor: 'Vó Zeniria' },
  { nome: 'Cooktop por indução', descricao: 'Cooktop 4 bocas por indução, vitrocerâmico.' },
  { nome: 'Jogo de panela', descricao: 'Jogo de panelas antiaderentes compatível com indução, linha Ceramic Vanilla.' },
  { nome: 'Bebedouro IBBL', descricao: 'Bebedouro elétrico com filtro e resfriamento.' },
  { nome: 'Faqueiro Aço Inox', descricao: 'Jogo de talheres em inox (24 peças ou mais).' },
  { nome: 'Conjunto de facas', descricao: 'Conjunto de facas de cozinha com suporte.' },
  { nome: 'Jogo de copos', descricao: 'Jogo de copos em vidro ou cristal.' },
  { nome: 'Jogo de potes de vidro', descricao: 'Jogos de potes herméticos de vidro para armazenar alimentos.' },
  { nome: 'Aspirador de pó', descricao: 'Aspirador de pó vertical.', reservado: true, reservadoPor: 'Mãe' },
  { nome: 'Jogo de toalhas de banho', descricao: 'Conjunto de toalhas de banho e rosto.' },
  { nome: 'Banquetas de madeira', descricao: 'Quatro banquetas altas para balcão ou ilha.', reservado: true, reservadoPor: 'Evandro / Josi' },
  { nome: 'Ferro de passar', descricao: 'Ferro de passar roupa a vapor ou central de vapor.' },
  { nome: 'Tanquinho', descricao: 'Máquina de lavar roupas semiautomática (tanquinho).', reservado: true, reservadoPor: 'Salete / Gerson' },
  { nome: 'Panela de pressão', descricao: 'Panela de pressão, 4,5 litros ou mais.', reservado: true, reservadoPor: 'Lurdes' },
  { nome: 'Batedeira', descricao: 'Batedeira planetária.' },
  { nome: 'Jogo de assadeiras', descricao: 'Conjunto de assadeiras e formas para forno (vidro, antiaderente ou alumínio).' },
  { nome: 'Jogo de jantar', descricao: 'Jogo de jantar (pratos, tigelas e travessas) para 6 pessoas.' },
  { nome: 'Jogo de pratos simples', descricao: 'Jogo de pratos rasos e fundos em porcelana, cerâmica ou vidro.' },
  { nome: 'Jogo de xicaras de café', descricao: 'Jogo de xicaras de café.' },
  { nome: 'Garrafa Termica', descricao: 'Garrafa de café termica.' },
  { nome: 'Cafeteira Italiana', descricao: 'Cafeteira italiana estilo bialetti.' },
  { nome: 'Frigideira', descricao: 'Frigideira antiaderente.' },
  { nome: 'Jogo de Cama', descricao: 'Jogo de cama casal algodão (colchão 1,38 x 1,88 x 30).' },
  { nome: 'Moedor de café', descricao: 'Moedor de café eletrico.' },
  { nome: 'Jogo de Utensílios de Cozinha', descricao: 'Jogo de utensílios de cozinha em silicone.' },
];
